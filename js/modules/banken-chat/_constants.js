...
export const DEMO_CUSTOMER_DATA = [
    ...
    { id: 'K-2024-0002', name: 'Schmidt, Peter', forderung: 18450, dpd: 21, segment: 'prioritaet', status: 'Offen' },
    { id: 'K-2024-0003', name: 'Weber KG', forderung: 85780, dpd: 14, segment: 'restrukturierung', status: 'Vereinbarung' },
    { id: 'K-2024-0004', name: 'Braun, Maria', forderung: 43210, dpd: 67, segment: 'abwicklung', status: 'Abschreibung' },
    { id: 'K-2024-0005', name: 'Hoffmann Bau GmbH', forderung: 387500, dpd: 48, segment: 'eskalation', status: 'Inkasso' },
    { id: 'K-2024-0006', name: 'Keller, Thomas', forderung: 45800, dpd: 42, segment: 'eskalation', status: 'Inkasso' },
    { id: 'K-2024-0007', name: 'Autohaus Berger', forderung: 189300, dpd: 55, segment: 'eskalation', status: 'Inkasso' },
    { id: 'K-2024-0008', name: 'Lehmann, Sandra', forderung: 32650, dpd: 18, segment: 'prioritaet', status: 'Offen' },
    { id: 'K-2024-0009', name: 'Meier Elektro OHG', forderung: 74200, dpd: 25, segment: 'prioritaet', status: 'Offen' },
    { id: 'K-2024-0010', name: 'Fischer, Hans', forderung: 26890, dpd: 12, segment: 'prioritaet', status: 'Zusage' },
    { id: 'K-2024-0011', name: 'Bäckerei Schulze', forderung: 127400, dpd: 28, segment: 'restrukturierung', status: 'Vereinbarung' },
    { id: 'K-2024-0012', name: 'Neumann, Klaus', forderung: 256000, dpd: 8, segment: 'restrukturierung', status: 'Vereinbarung' },
    { id: 'K-2024-0013', name: 'Gasthaus zum Löwen', forderung: 212800, dpd: 19, segment: 'restrukturierung', status: 'Vereinbarung' },
    { id: 'K-2024-0014', name: 'Werner, Sabine', forderung: 54560, dpd: 92, segment: 'abwicklung', status: 'Abschreibung' },
    { id: 'K-2024-0015', name: 'Maier Transporte', forderung: 178900, dpd: 78, segment: 'abwicklung', status: 'Abschreibung' },
    { id: 'K-2024-0016', name: 'Zimmermann, Frank', forderung: 32340, dpd: 105, segment: 'abwicklung', status: 'Abschreibung' },
    { id: 'K-2024-8847', name: 'Müller, Hans', forderung: 84230, dpd: 2, segment: 'prioritaet', status: 'Offen' },
    { id: 'K-2024-8846', name: 'Schmidt GmbH', forderung: 142890, dpd: 3, segment: 'prioritaet', status: 'Offen' },
    { id: 'K-2024-8845', name: 'Weber, Anna', forderung: 52150, dpd: 5, segment: 'prioritaet', status: 'Offen' },
